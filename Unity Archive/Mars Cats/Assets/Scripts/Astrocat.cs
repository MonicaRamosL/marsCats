...
public class Astrocat : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("Values of temperature in which character survives." +
        " If body temperature go out of values, character lose health")] private Vector2 temperatureRange = new Vector2(-20, 50);
    private float actualTemperature;
    [SerializeField, Tooltip("Max value for radiation resistance. " +
        "If radiation reach value, character dies")] private float maxRadiationResistance = 100;
    private float actualRadiation;
    [SerializeField, Tooltip("Max Health of the spacesuit. " +
        "If health reach 0, suits fails and character lose protection")] private float maxSuitHealth = 100;
